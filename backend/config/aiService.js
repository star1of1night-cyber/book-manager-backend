...
// تدعم: Anthropic Claude أو OpenAI (حسب الإعداد في .env)
// ============================================
...
// -------- الخيار ج: DeepSeek (رخيص جدًا، متوافق مع صيغة OpenAI) --------
...
// -------- الخيار د: Google Gemini (طبقة مجانية حقيقية بدون شحن رصيد) --------
